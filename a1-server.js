...
var consolere = require('console-remote-client').connect('console.re','80','A00219542_Assignment_One');
...
server.listen(server_port, server_ip_address, function(){
    ...
    console.re.log("Server IP adress = " +server_ip_address + "Server port = " +server_port);
    // ASSIGNMENT
